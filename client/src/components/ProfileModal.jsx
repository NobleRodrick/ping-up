 ...
 *
 * This component is used to edit the profile of the user. It accepts a setShowEdit
 * function as a prop, which is used to close the modal when the user clicks
 * the cancel button or submits the form.
 *
 ...
 * - Bio
 * - Location
 * The form also includes a cancel button and a save changes button.
 *
 * When the user submits the form, the component calls the setShowEdit function
 * with false as the argument to close the modal.
 *
 * @param setShowEdit {function} - a function to close the modal
 */
