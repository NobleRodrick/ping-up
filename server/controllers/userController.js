    ...
    try {
        ...
        if (profile) {
            ...
            const response = await imagekit.upload({
                file: buffer,
                filename: profile.originalname, //check this line
            })
        ...
        if (cover) {
            ...
            const response = await imagekit.upload({
                file: buffer,
                filename: cover.originalname, //check this line
            })
...
export const sendConnectionRequest = async (req, res) => {
    try {
        ...
        // chack if user has sent more than 20 connection  requests in the past 24 hours
